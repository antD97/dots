...
-- Wibar
--------------------------------------------------------------------------------
-- Create a exit menu widget
exit_widget = wibox.widget.textbox("") -- power icon
...
root.buttons(gears.table.join(
    awful.button({ }, 1, function() exit_menu:hide() end)
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "w", function() exit_menu:show() end,
              {description = "Exit menu", group = "Awesome"}),
...
exit_widget:connect_signal("button::press", function() exit_menu:show() end)
